...
import io.github.ms100.cacheasmulti.cache.convert.converter.ConcurrentMapCacheToEnhancedCacheConverter;
...
class EnhancedCacheConversionServiceTest {
    ...
    void convert() {
        ...
        assertTrue(convertConcurrentMap instanceof ConcurrentMapCacheToEnhancedCacheConverter.EnhancedConcurrentMapCache);
        ...
        if (redisCacheManager != null) {
            ...
            //assertTrue(convertRedis instanceof RedisCacheToEnhancedCacheConverter.EnhancedRedisCache);
        }
