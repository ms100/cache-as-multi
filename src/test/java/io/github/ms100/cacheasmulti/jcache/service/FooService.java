...
public class FooService {
    ...
    public Map<Integer, String> getMultiFoo(@SplitParam(4) @CacheAsMulti Set<Integer> ids, String str) {
    ...
    public void delMultiFoo(@SplitParam(4) @CacheAsMulti @CacheKey Set<Integer> ids, @CacheKey String str, String str2) {
